...
## 13) Обязательная синхронизация с пользовательской документацией

Любая доработка, меняющая поведение бота, обязана обновлять:
- операторскую документацию в `docs/user/*`,
